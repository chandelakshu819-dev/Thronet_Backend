...
class AnalyticsController {
   ...
   */
  private async canAccessMentorAnalytics(req: Request, mentorId: string): Promise<boolean> {
    ...
    console.log({
      ...
      requestedMentorId: req.params.mentorId || mentorId,
    });
    ...
    console.log({
      mentorFound: !!mentor,
      mentorProfileId: mentor?.mentorId,
    });
